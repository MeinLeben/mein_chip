...
public:
	...
	void update_mouse_position(int32_t x, int32_t y, uint32_t display_x, uint32_t display_y, uint32_t display_width, uint32_t display_height, uint32_t display_pixel_scale);
...
private:
	...
	TextLabel* m_mouse_position = nullptr;
};